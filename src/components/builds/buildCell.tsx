...
import AbilityBuilds from "../HeroBuilds/abillityBuild/abilityBuild"
import ItemBuild from "../HeroBuilds/itemBuild/itemBuild"
import { NeutralItems } from "../HeroBuilds/itemBuild/neutralItems/neutralItems"
import StartingItems from "../HeroBuilds/itemBuild/startingItems/startingItems"
...
import { CoreItem } from "../HeroBuilds/itemBuild/itemGroups/groupBytime"
...
type Talents = [string, Talent][];
interface DotaHeroBuilds {
    item_builds: {
        [key: string]: CoreItem[];
    }[];
    ability_builds: AbilityBuildEntry[];
    starting_items: [string, number][];
    neutral_items: (NeutralItem | [string, NeutralItem])[];
    talents: Talents;
...
export const BuildCell = ({ dataLength, data, totalMatchData, heroList, itemData, role, buildData, heroData, updateMatchData, heroName }: BuildCellProps) => {
