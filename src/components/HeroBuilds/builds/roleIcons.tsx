...
@keyframes flameFlicker {
  ...
  20%  { opacity: 0.85; transform: scaleX(0.97) scaleY(1.03); }
  40%  { opacity: 1;    transform: scaleX(1.02) scaleY(0.97); }
  60%  { opacity: 0.9;  transform: scaleX(0.98) scaleY(1.02); }
  80%  { opacity: 1;    transform: scaleX(1.01) scaleY(0.99); }
...
function SoftSupportSvg() {
  ...
  const flameTop    = hovered ? "hsl(45,100%,60%)" : "hsl(29,76%,39%)";
  const flameBottom = hovered ? "hsl(15,100%,55%)" : "hsl(335,58%,51%)";
  return (
    <>
      {hovered && <style>{flickerKeyframes}</style>}
      <svg
        height="30"
        viewBox="0 0 24 24"
      ...
      >
        ...
        <path
          ...
          style={hovered ? { animation: "flameFlicker 0.6s ease-in-out infinite", transformOrigin: "15px 8px" } : undefined}
        />
        <defs>
          <linearGradient id="wrist_66_dark" x1="2.19928" y1="13.9623" x2="2.19928" y2="23.0759" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="1" stopColor="#7B7373" />
          </linearGradient>
          <linearGradient id="flame_66_dark" x1="20.1087" y1="-1.17264e-7" x2="10.053" y2="15.0821" gradientUnits="userSpaceOnUse">
            <stop stopColor={flameTop}    style={{ transition: "stop-color 0.2s" }} />
            <stop offset="1" stopColor={flameBottom} style={{ transition: "stop-color 0.2s" }} />
          </linearGradient>
        </defs>
      </svg>
    </>
...
@keyframes sparkleTwinkle {
  0%, 100% { filter: drop-shadow(0 0 4px hsl(155,80%,60%)); }
  33%       { filter: drop-shadow(0 0 10px hsl(140,90%,70%)) brightness(1.3); }
  66%       { filter: drop-shadow(0 0 6px hsl(165,85%,65%)) brightness(1.15); }
}
`;

function HardSupportSvg() {
  const [hovered, setHovered] = useState(false);
  const sparksTop    = hovered ? "hsl(145,90%,75%)" : "hsl(155,31%,48%)";
  const sparksBottom = hovered ? "hsl(158,85%,60%)" : "hsl(158,78%,28%)";
  return (
    <>
      {hovered && <style>{sparkleKeyframes}</style>}
      <svg
        height="30"
        viewBox="0 0 24 24"
        onMouseEnter={() => setHovered(true)}
        ...
        style={{
          cursor: "pointer",
          animation: hovered ? "sparkleTwinkle 1.2s ease-in-out infinite" : "none",
      ...
      >
        ...
        <path
          ...
          fill="url(#sparks_hs_dark)"
        />
        <defs>
          <linearGradient id="wrist_hs_dark" x1="2.19928" y1="13.5766" x2="2.19928" y2="22.9711" gradientUnits="userSpaceOnUse">
            <stop stopColor="#DEDEDE" />
            <stop offset="1" stopColor="#7B7373" />
          </linearGradient>
          <linearGradient id="sparks_hs_dark" x1="7.5" y1="0" x2="24" y2="13.5" gradientUnits="userSpaceOnUse">
            <stop stopColor={sparksTop}    style={{ transition: "stop-color 0.2s" }} />
            <stop offset="1" stopColor={sparksBottom} style={{ transition: "stop-color 0.2s" }} />
          </linearGradient>
        </defs>
      </svg>
    </>
...
function MidlaneSvg() {
  const [hovered, setHovered] = useState(false);
  const topColor    = hovered ? "hsl(187,65%,55%)" : "hsl(187,60%,40%)";
  const bottomColor = hovered ? "hsl(188,55%,50%)" : "hsl(188,48%,38%)";
  return (
    <svg
      height="30"
      viewBox="0 0 24 24"
      ...
      style={{
        ...
        filter: hovered ? "drop-shadow(0 0 3px hsl(187,70%,60%))" : "none",
    ...
    >
      <path
        ...
        fill="url(#bow_arrow_dark)"
      />
      <defs>
        <linearGradient id="bow_arrow_dark" x1="25.0809" y1="-6.25872e-7" x2="1.25351" y2="22.5728" gradientUnits="userSpaceOnUse">
          <stop stopColor={topColor}    style={{ transition: "stop-color 0.25s" }} />
          <stop offset="1" stopColor={bottomColor} style={{ transition: "stop-color 0.25s" }} />
        </linearGradient>
      </defs>
    </svg>
  );
...
const lightningPulseKeyframes = `
@keyframes lightningPulse {
  0%, 100% { filter: drop-shadow(0 0 3px hsl(45,90%,55%)); }
  50%       { filter: drop-shadow(0 0 6px hsl(45,95%,65%)) brightness(1.1); }
}
`;

function OfflaneSvg() {
  const [hovered, setHovered] = useState(false);
  const topColor    = hovered ? "hsl(40,90%,58%)"  : "hsl(33,79%,46%)";
  const bottomColor = hovered ? "hsl(33,85%,48%)" : "hsl(34,82%,36%)";
  return (
    <>
      {hovered && <style>{lightningPulseKeyframes}</style>}
      <svg
        height="30"
        viewBox="0 0 24 24"
        onMouseEnter={() => setHovered(true)}
        ...
        style={{
          cursor: "pointer",
          animation: hovered ? "lightningPulse 0.75s ease-in-out infinite" : "none",
          transition: "filter 0.2s",
        }}
      >
        <path
          ...
          fill="url(#shield_dark)"
        />
        <defs>
          <linearGradient id="shield_dark" x1="12" y1="0.75" x2="12" y2="23.25" gradientUnits="userSpaceOnUse">
            <stop stopColor={topColor}    style={{ transition: "stop-color 0.2s" }} />
            <stop offset="1" stopColor={bottomColor} style={{ transition: "stop-color 0.2s" }} />
          </linearGradient>
        </defs>
      </svg>
    </>
...
const gleamKeyframes = `
@keyframes swordGleam {
  0%   { filter: drop-shadow(0 0 2px hsl(220,80%,70%)); }
  40%  { filter: drop-shadow(0 0 5px hsl(210,90%,80%)) brightness(1.15); }
  100% { filter: drop-shadow(0 0 2px hsl(220,80%,70%)); }
}
`;

function SafelaneSvg() {
  const [hovered, setHovered] = useState(false);
  const bladeTop    = hovered ? "hsl(220,70%,72%)" : "hsl(231,54%,59%)";
  const bladeBottom = hovered ? "hsl(225,55%,58%)" : "hsl(230,43%,45%)";
  const hiltTop     = hovered ? "#EEEEEE"          : "#DDD";
  const hiltBottom  = hovered ? "#999999"          : "#838383";
  return (
    <>
      {hovered && <style>{gleamKeyframes}</style>}
      <svg
        height="30"
        viewBox="0 0 24 24"
        onMouseEnter={() => setHovered(true)}
        ...
        style={{
          cursor: "pointer",
          animation: hovered ? "swordGleam 1s ease-in-out infinite" : "none",
          transition: "transform 0.3s",
          transform: hovered ? "rotate(5deg) scale(1.04)" : "none",
        }}
      >
        <path
          fillRule="evenodd"
        ...
        />
        <defs>
          <linearGradient id="hilt_dark" x1="3" y1="18" x2="6" y2="21.75" gradientUnits="userSpaceOnUse">
            <stop stopColor={hiltTop}    style={{ transition: "stop-color 0.3s" }} />
            <stop offset="1" stopColor={hiltBottom} style={{ transition: "stop-color 0.3s" }} />
          </linearGradient>
          <linearGradient id="blade_dark" x1="23.915" y1="9.91042e-8" x2="6.38719" y2="17.6213" gradientUnits="userSpaceOnUse">
            <stop stopColor={bladeTop}    style={{ transition: "stop-color 0.3s" }} />
            <stop offset="1" stopColor={bladeBottom} style={{ transition: "stop-color 0.3s" }} />
          </linearGradient>
        </defs>
      </svg>
    </>
...
export function RoleIcon({ role }: { role: RoleStrings }) {
  switch (role) {
    case "Hard Support": return <HardSupportSvg />;
    case "Support":      return <SoftSupportSvg />;
    case "Roaming":
    case "Offlane":      return <OfflaneSvg />;
    case "Midlane":      return <MidlaneSvg />;
    case "Safelane":     return <SafelaneSvg />;
    default:             return null;
  }
}
