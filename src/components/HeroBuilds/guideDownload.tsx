...
const GuideGuide = () => {
  ...
  return (
    ...
    >
      ...
      <h4>Step 2</h4>
      <a
        href="https://greasyfork.org/en/scripts/372234-steam-guide-subscribe-all"
        rel="noreferrer"
        target="_blank"
      >
        <p>download this tampermonkey script</p>
        <FontAwesomeIcon
      ...
      <a
        target="_blank"
        rel="noreferrer"
        href="https://steamcommunity.com/id/27bslash/myworkshopfiles/?section=guides"
      >
