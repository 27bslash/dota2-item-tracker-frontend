      ...
      <Box sx={{ display: "flex" }}>
        ...
        >
            ...
            {[
              ...
              return (
                <ListItem
                  ...
                  onClick={() =>
                    setRole(
                      role === roleString ? "" : (roleString as RoleStrings),
                    )
                  }
                  sx={{
                    backgroundColor: highLight ? "#2d8680" : "inherit",
                  }}
                >
                  {/* <ListItemIcon /> */}
                  <ListItemText
          ...
          <List>
            <ListItem
              sx={{
                backgroundColor: sortType === "trends" ? "#2d8680" : "inherit",
              }}
              disablePadding
              className="sidebar-item"
              onClick={() =>
                setSortType(sortType === "trends" ? undefined : "trends")
              }
            >
              <ListItemText
                disableTypography
            ...
            <ListItem
              sx={{
                backgroundColor: sortType === "picks" ? "#2d8680" : "inherit",
              }}
              disablePadding
              className="sidebar-item"
              onClick={() =>
                setSortType(sortType === "picks" ? undefined : "picks")
              }
            >
              <ListItemText
                disableTypography
            ...
            <ListItem
              sx={{
                backgroundColor: sortType === "winrate" ? "#2d8680" : "inherit",
              }}
              disablePadding
              className="sidebar-item"
              onClick={() =>
                setSortType(sortType === "winrate" ? undefined : "winrate")
              }
            >
              <ListItemText
                disableTypography
            ...
            <ListItem
              sx={{
                backgroundColor: sortType === "bans" ? "#2d8680" : "inherit",
              }}
              disablePadding
              className="sidebar-item"
              onClick={() =>
                setSortType(sortType === "bans" ? undefined : "bans")
              }
            >
              <ListItemText
                disableTypography
